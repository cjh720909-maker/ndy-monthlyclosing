module.exports = [
"[project]/src/app/settlement/absence/data:e11337 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$settlement$2f$absence$2f$data$3a$e11337__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/settlement/absence/data:e11337 [app-ssr] (ecmascript) <text/javascript>");
'use client';
;
;
;
...
function VehicleAbsencePage() {
    ...
    const handleSearch = async ()=>{
        setIsSearching(true);
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$settlement$2f$absence$2f$data$3a$e11337__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getAbsenceData"])(startDate, endDate);
            setResults(data);
        } catch (error) {
            console.error(error);
...
//# sourceMappingURL=_30c255b4._.js.map