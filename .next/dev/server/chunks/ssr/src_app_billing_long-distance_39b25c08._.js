module.exports = [
"[project]/src/app/billing/long-distance/data:be54f5 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/billing/long-distance/data:b3be58 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/billing/long-distance/data:c749a1 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$billing$2f$long$2d$distance$2f$data$3a$be54f5__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/billing/long-distance/data:be54f5 [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$billing$2f$long$2d$distance$2f$data$3a$b3be58__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/billing/long-distance/data:b3be58 [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$billing$2f$long$2d$distance$2f$data$3a$c749a1__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/billing/long-distance/data:c749a1 [app-ssr] (ecmascript) <text/javascript>");
'use client';
;
;
;
...
function LongDistanceVehiclePage() {
    ...
    async function loadData() {
        startTransition(async ()=>{
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$billing$2f$long$2d$distance$2f$data$3a$be54f5__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getVehicles"])(currentYear);
            setVehicles(data);
        });
    }
    ...
    async function handleSave() {
        ...
        startTransition(async ()=>{
            try {
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$billing$2f$long$2d$distance$2f$data$3a$b3be58__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["saveVehicle"])(formData, currentYear);
                if (result.success) {
                    // alert('저장되었습니다.');
    ...
    async function handleDelete(id) {
        ...
        startTransition(async ()=>{
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$billing$2f$long$2d$distance$2f$data$3a$c749a1__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteVehicle"])(id);
            await loadData();
...
//# sourceMappingURL=src_app_billing_long-distance_39b25c08._.js.map