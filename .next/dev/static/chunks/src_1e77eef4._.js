...
function VehicleAbsencePage() {
    ...
    const handleSearch = async ()=>{
        setIsSearching(true);
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$settlement$2f$absence$2f$data$3a$c608c6__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getAbsenceData"])(startDate, endDate);
            setResults(data);
        } catch (error) {
            console.error(error);
...
//# sourceMappingURL=src_1e77eef4._.js.map